...
public class reversinglinkedlistthroughrecursion{
    Node head;
    private int size;
 reversinglinkedlistthroughrecursion() {
   this.size=0;
   }
 class Node{
    String data;
 ...
 public static void main(String[] args){
    reversinglinkedlistthroughrecursion list = new reversinglinkedlistthroughrecursion();
    list.addFirst("a");
    list.addFirst("is");
